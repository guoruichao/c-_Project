...
namespace libCommon.Gzip
{
    ...
    public class GZipStream : System.IO.Stream
    {
        ...
        public override long Position
        {
            get
            {
                if (this._baseStream._streamMode == libCommon.Gzip.ZlibBaseStream.StreamMode.Writer)
                    return this._baseStream._z.TotalBytesOut + _headerByteCount;
                if (this._baseStream._streamMode == libCommon.Gzip.ZlibBaseStream.StreamMode.Reader)
        ...
        {
            if (_disposed) throw new ObjectDisposedException("GZipStream");
            if (_baseStream._streamMode == libCommon.Gzip.ZlibBaseStream.StreamMode.Undefined)
            {
